import kartaImg from "./sample_karta.jpg"
import React from 'react';
import './widok_gry.css';
...
function App() {
  ...
  return (
    ...
    <header className="widok_gry_header">
      ...
      <img src={kartaImg} alt="karta"></img>
      <img id="druga_top" src={kartaImg} alt="karta"></img>
      <img src={kartaImg} alt="karta"></img>
      <img src={kartaImg} alt="karta"></img>
      <img src={kartaImg} alt="karta"></img>
      <img id="ostatnia_karta" src={kartaImg} alt="karta"></img>
      </div>
