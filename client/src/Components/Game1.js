    ...
    <div className="App">
        ...
        <div className="karty_top">
          <div className="flexbox-draw">
            <Board id="board-draw" className="board">
              <Card
                id="card-1"
                className="card v3 diamonds cyberpunk"
                draggable="true"
              ></Card>
            </Board>
            <Board id="board-draw2" className="board">
              <Card
                id="card-2"
                className="card v5 spades cyberpunk"
                draggable="true"
              ></Card>
            </Board>
          </div>
          ...
          <div className="flexbox-blank">
            <Board id="board-3" className="board">
              <Card
                id="card-3"
                className="card v9 clubs cyberpunk"
                draggable="true"
              ></Card>
            </Board>
            <Board id="board-4" className="board">
              <Card
                id="card-4"
                className="card v9 hearts cyberpunk"
                draggable="true"
              ></Card>
            </Board>
            <Board id="board-5" className="board">
              <Card
                id="card-5"
                className="card vA diamonds cyberpunk"
                draggable="true"
              ></Card>
            </Board>
            <Board id="board-6" className="board">
              <Card
                id="card-6"
                className="card v6 hearts cyberpunk"
                draggable="true"
              ></Card>
            </Board>
          </div>
        ...
        <div className="karty_bottom">
          <div className="flexbox-bottom">
            <Board id="board-3" className="board">
              <Card
                id="card-7"
                className="card vQ hearts cyberpunk"
                draggable="true"
              ></Card>
            </Board>
            <Board id="board-4" className="board">
              <Card
                id="card-8"
                className="card v5 hearts cyberpunk"
                draggable="true"
              ></Card>
            </Board>
            <Board id="board-5" className="board">
              <Card
                id="card-9"
                className="card v4 hearts cyberpunk"
                draggable="true"
              ></Card>
            </Board>
            <Board id="board-6" className="board">
              <Card
                id="card-10"
                className="card vJ clubs cyberpunk"
                draggable="true"
              ></Card>
            </Board>
            <Board id="board-6" className="board">
              <Card
                id="card-11"
                className="card vK hearts cyberpunk"
                draggable="true"
              ></Card>
              <Card
                id="card-15"
            ...
            <Board id="board-6" className="board">
              <Card
                id="card-13"
                className="card v2 hearts cyberpunk"
                draggable="true"
              ></Card>
            </Board>
          </div>
      ...
      <div className="bottom_section">
        ...
        <div className="info_section">
          ...
          <p className="is_possible">
            Czy możliwe jest skończenie partii: TAK/NIE
          </p>
